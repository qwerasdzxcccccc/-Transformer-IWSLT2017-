...
from src.ablation.model_ablation import TransformerEncDec
import sacrebleu
import numpy as np
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='results/run_experiments/run_ablation')
    parser.add_argument('--seed', type=int, default=42)
    parser.add_argument('--grad_clip', type=float, default=1.0)
    parser.add_argument('--device', type=str, default='cuda')
    # Ablation arguments
    parser.add_argument('--dropout', type=float, default=0.1)
    parser.add_argument('--use_relpos', type=str, default='true')
    parser.add_argument('--use_gelu', type=str, default='true')
    ...
    use_relpos = args.use_relpos.lower() == 'true'
    use_gelu = args.use_gelu.lower() == 'true'
    ...
    model = TransformerEncDec(src_vocab_size=vocab_size_actual, tgt_vocab_size=vocab_size_actual,
                              ...
                              use_relpos=use_relpos, use_gelu=use_gelu).to(device)
