...
from src.ablation.model_no_relpos import TransformerEncDec  # 使用不带相对位置偏置的模型
import sacrebleu
import numpy as np
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='results/run_experiments/run_no_relpos')
    ...
    model = TransformerEncDec(src_vocab_size=vocab_size_actual, tgt_vocab_size=vocab_size_actual,
                              ...
                              max_len=args.max_len).to(device)  # 注意这里移除了 rel_pos_max_distance 参数
